# CodeQL Setup for deepiri-logger
...
- `.github/workflows/codeql.yml`
  - Defines when scans run and how GitHub Actions executes CodeQL for JavaScript/TypeScript, Python, and Rust.
...
```
This workflow currently runs analysis for JavaScript/TypeScript, Python, and Rust.
...
This workflow currently analyzes JavaScript/TypeScript, Python, and Rust:
...
Only change this value when this repository adds or removes production code in a supported language.
